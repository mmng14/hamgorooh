...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $page_content = $ROOT_DIR . "app/admin/views/reportage.view.php";
    ...
    try {
        ...
        if ($tblId != "") {
            ...
            foreach ($subject_sites as $subject_site) {
                ...
                $reportage_post = array("id" => null, "subject_id" => $subj_id, "category_id" => $cat_id,
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' &&    isset($_POST["cmd"]) && $_POST["cmd"] == $_SESSION["LISTING_CODE"] && isset($_SERVER['HTTP_X_REQUESTED_WITH']) &&
    ...
    $html = view_to_string("_reportage.php", "app/admin/views/partial/", $rows, $pagination, $SUBFOLDER_NAME, $HOST_NAME);
    echo $html;
    exit;
}
