...
window.onload = function () {
    ...
    $("#results").load(HOST_NAME + "admin/ads/", {"cmd": $('#listing_code').val(),"_csrf" : $("#_csrf").val()}); //load initial records
    ...
    $("#results").on("click", ".pagination a", function (e) {
        ...
        $("#results").load(HOST_NAME + "admin/ads/", {
                "page": page,
                "order": order,
                "perpage": perpage,
                "_csrf" : $("#_csrf").val(),
