$(document).ready(function () {
    ...
    registerFormValidation = $("#formGallery").validate({
        rules: {
            title: {
...
window.onload = function () {
    ...
    $("#results").load(HOST_NAME + "admin/gallery/", {"cmd": $('#listing_code').val(),"_csrf" : $("#_csrf").val()}); //load initial records
    ...
    $("#results").on("click", ".pagination a", function (e) {
        ...
        $("#results").load(HOST_NAME + "admin/gallery/", {
                "page": page,
                "order": order,
                "perpage": perpage,
                "_csrf" : $("#_csrf").val(),
