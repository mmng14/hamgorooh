...
window.onload = function () {
  ...
  $("#results").load(HOST_NAME + "admin/posts/", {
    ...
    $("#results").load(
      ...
      function () {
        ...
        window.history.pushState(
          "obj",
          "newtitle",
          HOST_NAME + "admin/posts/" + cat_filter + "/" + page
        );
        UnLoadElement("#divResults");
      }
    );
...
$('#sub_category_filter').on('change', function (e) {
    loadData();
});
...
function telegram(id) {
  ...
  $.ajax({
    ...
    data:
      ...
      "&_csrf=" +
      _csrf +
      "&check=" + $('#send_to_telegram_code').val(),
    dataType: "json",
    cache: false,
...
function sendToSubjectSite(id) {
  ...
  $.ajax({
    ...
    data:
      ...
      "&_csrf=" +
      _csrf +
      "&check=" + $('#send_to_subjects_code').val(),
    dataType: "json",
    cache: false,
    success: function (result) {
      console.log(result);
...
function reportage(id) {
  ...
  $.ajax({
    ...
    data:
      ...
      "&_csrf=" +
      _csrf +
      "&check=" + $('#send_to_reportage_code').val(),
    dataType: "json",
    cache: false,
    success: function (result) {
      console.log(result);
