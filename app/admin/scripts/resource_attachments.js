...
window.onload = function () {
  $("#loader").show();
  $("#results").load(HOST_NAME + "admin/resources-attachments/", {
  ...
  $("#results").on("click", ".pagination a", function (e) {
    ...
    $("#results").load(
      HOST_NAME + "admin/resources-attachments/",
      {
        page: page,
        order: order,
        perpage: perpage,
  ...
  if (checkInputs == true) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          url: HOST_NAME + "admin/resources-attachments/",
          type: "POST",
          data: {
            obj: id,
            _csrf: _csrf,
...
function getParentListData(id) {
  ...
  $.ajax({
    type: "POST",
    url: HOST_NAME + "admin/resources-attachments/",
    data: "id=" + id + "&resourceId=" + resourceId + "&check=" + listing_code + "&_csrf=" + _csrf,
    dataType: "json",
    cache: false,
    success: function (result) {
