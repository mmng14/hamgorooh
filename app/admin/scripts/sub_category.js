$(document).ready(function () {
    ...
    registerFormValidation = $("#frmSubCategory").validate({
        rules: {
            name: {
...
window.onload = function () {
    ...
    var category = $('#this_category_id').val();
    $("#results").load(HOST_NAME + "admin/sub_category/", { "cmd": $('#listing_code').val(), "_csrf": $("#_csrf").val(),"category": category  }); //load initial records
    ...
    $("#results").on("click", ".pagination a", function (e) {
        ...
        $("#results").load(HOST_NAME + "admin/sub_category/", {
            "page": page,
            "order": order,
            "perpage": perpage,
            "_csrf": $("#_csrf").val(),
    ...
    if (checkInputs == true) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            url: HOST_NAME + "admin/sub_category/",
            type: "POST",
            data: {
              obj: id,
              _csrf: _csrf,
