                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">مدیریت درباره ما</div>
            ...
            <div class="modal-dialog window-popup create-photo-album" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h6 class="title">افزودن / ویرایش درباره ما</h6>
                    </div>
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formAbout" id="formAbout" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="briefDescription" id="briefDescription" cols="45" rows="3" style="resize:none"></textarea>
                            </div>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/about.js"></script>