                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formAds" id="formAds" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-picker" name="startDate" id="startDate" autocomplete="off">

                            </div>
                            <div class="form-group">
                                <label class="control-label">تاریخ پایان</label>

                                <input type="text" class="form-control date-picker" name="endDate" id="endDate" autocomplete="off">
                            ...
                            <div class="form-group">
                                <label control-label">ترتیب</label>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/ads.js"></script>