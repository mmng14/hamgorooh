                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">ارسال تبلیغات</div>

                            <div class="block-btn align-right">
                                <!-- <button class="btn btn-primary btn-md-2" data-toggle="modal"  onclick="sendToAll('<?= $reportage_id ?>');">ارسال به همه گروهها
                                </button> -->
                                <button class="btn btn-primary btn-md-2" data-toggle="modal" onclick="sendToAll('<?= $ads_id ?>');">ارسال به همه گروهها
                                </button>

                                <input type="hidden" id="adsId" name="adsId" value="<?= $ads_id ?>" />
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/ads_subjects.js"></script>