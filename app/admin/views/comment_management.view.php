			...
			<div class="ui-block">
				...
				<table class="forums-table">
					...
					<tr>
						...
						<td class="freshness">
                        <a href="<?php echo $HOST_NAME; ?>admin/comments/<?= $subject["id"]; ?>" class="btn btn-sm bg-blue">مدیریت<div class="ripple-container"></div></a>
						</td>
					</tr>
                    <?php endforeach; ?>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/comment_management.js"></script>