                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formCrawlerSources" id="formCrawlerSources" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="direction: ltr;text-align: left;" name="source_link" id="source_link">
                            </div>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/crawler_sources.js"></script>