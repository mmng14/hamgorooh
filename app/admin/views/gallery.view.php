                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">مدیریت گالری تصاویر</div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formGallery" id="formGallery" role="form" method="post">
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/gallery.js"></script>