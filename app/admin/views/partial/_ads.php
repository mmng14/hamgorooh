                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-date">
                            ...
                            <a class="btn btn-purple  btn-sm btn-link-custom" href="<?= $HOST_NAME ?>/admin/ads_subjects/<?= $result['id'] ?>" title=" ارسال به سایت انتخابی ">
                                <i class="fa fa-paper-plane list-ctrl-icon"></i>
                            </a>

                            <button class="btn btn-blue  btn-sm" onclick="sendToSubjects(<?= $result['id'] ?>)" title=" ارسال به همه سایتها ">
                                <i class="fa fa-paper-plane list-ctrl-icon"></i>
                            </button>
