    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">سال تولد</th>
                <th class="hidden-phone">سال وفات</th>
            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['full_name']; ?></b></td>
                        <td class="mailbox-subject">
                            <img alt="" src="<?= $HOST_NAME . $result['photo_address'] ?>" width="40" />
                        </td>
                        <!-- <td class="mailbox-subject"><b><?= $result['brief_description']; ?></b></td> -->
                        <td class="mailbox-subject"><b><?= $result['start_year']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['end_year']; ?></b></td>
