            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['address']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['telephones']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['mobile']; ?></b></td>
