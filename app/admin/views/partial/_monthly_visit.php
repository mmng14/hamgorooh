    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-480">سال</th>
                <th class="hidden-phone">ماه</th>
                <th class="hidden-phone"> بازدید</th>
                <th class="hidden-phone">بازید منحصر بفرد</th>
                <th class="hidden-phone">مجموع امتیاز</th>
                <th class="hidden-phone">رتبه</th>
                <th class="hidden-phone">تاریخ محاسبه</th>
            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['year']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['month']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['total_visit']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['unique_visit']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['total_points']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['rank']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['calculate_date']; ?></b></td>
