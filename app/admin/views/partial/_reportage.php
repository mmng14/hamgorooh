            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['post_code']; ?></b></td>
                        <td class="mailbox-subject">
                            <img alt="" src="<?=  $result['thumb_address'] ?>" width="90px" height="50px" />
                        </td>
                        ...
                        <td class="mailbox-date">
                            ...
                            <a class="btn btn-purple btn-sm btn-link-custom"  href="<?=$HOST_NAME?>/admin/reportage_subjects/<?=$result['id']?>"  title=" ارسال به سایت انتخابی " >
								<i class="fa fa-paper-plane  list-ctrl-icon"></i>
							</a>
						  
						  	<button class="btn btn-blue btn-sm" 
								onclick="sendToSubjects('<?= $result['id'] ?>')" title=" ارسال به همه سایتها " >
								<i class="fa fa-paper-plane  list-ctrl-icon"></i>
                            </button>
