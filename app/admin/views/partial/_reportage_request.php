    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">شناسه پست</th>
                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject">
                            <a href="<?= $HOST_NAME . $result['file_address'] ?>"><b>دانلود</b></a>
                        </td>
                        <td class="mailbox-subject">
                            <a href="<?= $result['back_link_address'] ?>"><b>لینک</b></a>
                        </td>
                        <td class="mailbox-subject"><b><?= $result['back_link_name'] ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['post_id'] ?></b></td>
                        <td class="mailbox-subject"><a href="<?= $result['reportage_link'] ?>"><b>لینک</b></a></td>
