                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-date">
                            ...
                            <button class="btn btn-green btn-sm" onclick="sendToSubjects('<?= $result['id'] ?>')" title=" ارسال ریپورتاژ ">
                                <i class="fa fa-paper-plane  list-ctrl-icon"></i>
                            </button>

                            <button class="btn btn-danger btn-sm" onclick="deleteToSubjects('<?= $result['id'] ?>')" title=" حذف ریپورتاژ ">
                                <i class="fa fa-paper-plane  list-ctrl-icon"></i>
                            </button>
                        </td>
