    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <!-- <th class="hidden-phone">شرح مختصر</th> -->
                <th class="hidden-phone">موضوعات مرتبط</th>
                <th class="hidden-phone">سال انتشار</th>
                <th class="hidden-phone">ضمایم</th>
                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject">
                            <img alt="" src="<?= $HOST_NAME . $result['photo_address'] ?>" width="40" />
                        </td>
                        <!-- <td class="mailbox-subject"><b><?= $result['brief_description']; ?></b></td> -->
                        <td class="mailbox-subject"><b><?= $result['subject_names']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['publish_year']; ?></b></td>
                        <td class="mailbox-subject"><a href="<?= $HOST_NAME?>admin/resources-attachments/<?= $result['id']; ?>"><i class="fa fa-3x fa-paperclip"></i></a></td>
