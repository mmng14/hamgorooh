    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">کلمه عبور </th>
                <th class="hidden-phone">اطلاعات تماس</th>
                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-date">
                            <a class="btn btn-warning btn-sm btn-link-custom" href="<?=$HOST_NAME?>/admin/user_subjects/<?=$result['id']?>">
                                <i class="fa fa-group list-ctrl-icon"></i>
                            </a>
                            <a class="btn btn-primary btn-sm btn-link-custom" href="<?=$HOST_NAME?>/admin/user_groups/<?=$result['id']?>">
                                <i class="fa fa-group list-ctrl-icon"></i>
                            </a>

                            <a class="btn btn-info btn-sm btn-link-custom" data-toggle="modal" href="#passModal" onclick="setPassData('<?=$result['id']?>')">
                                <i class="fa fa-key list-ctrl-icon"></i>
                            </a>
                            <a class="btn btn-primary btn-sm btn-link-custom" data-toggle="modal" href="#myModal" onclick="setData('<?= $result['id'] ?>')">
