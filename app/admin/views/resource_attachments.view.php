    ...
    <div class="row">
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">مدیریت ضمایم منابع</div>
                            <input type="hidden" id="selected_resource_id" name="selected_resource_id" value="<?= $selected_resouece["id"] ?>" />
                            ...
                            <a href="<?= $HOST_NAME?>/admin/resources/" class="more">

                                <svg class="olymp-popup-left-arrow"><use xlink:href="#olymp-popup-left-arrow"></use></svg>
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <!-- Tab panes -->
                    <h6 class="title"> <span style="color: #999;"> ضمایم مربوط به :  </span><b><?= $selected_resouece["title"] ?></b></h6>
            ...
            <div class="modal-dialog window-popup create-photo-album" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formResourceAttachments" id="formResourceAttachments" role="form" method="post">
                            <input type="hidden" id="hashId" name="hashId" />
                            <input type="hidden" id="resource_id" name="resource_id" value="<?= $selected_resouece["id"] ?>" />
                            <input type="hidden" id="_csrf" name="_csrf" value="<?php echo $_csrf; ?>" />
                            <div class="form-group">
                                <label for="title" class="control-label">عنوان </label>
                                <input type="text" class="form-control " style="text-align: center;direction: ltr;" name="title" id="title">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " style="text-align: center;direction: ltr;" name="link_address" id="link_address">
                            </div>
                            <div class="form-group">
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/resource_attachments.js"></script>