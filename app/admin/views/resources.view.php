                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            ...
                            <div class="block-btn align-right">
                                <label> موضوع: </label>
                                <select id="subject_filter" name="subject_filter" onChange="loadData();" class="selectpicker form-control " aria-controls="sample_1">
            ...
            <div class="modal-dialog window-popup create-photo-album" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formResources" id="formResources" role="form" method="post">
                            ...
                            <div class="form-group">
                                <input type="hidden" id="subject_ids" name="subject_ids" />
                                <label for="subjects" class=" control-label">موضوعات مرتبط</label>
                                <div id="subjects_div">
                                    <select id="subjects" name="subjects" class="form-control multi-select-full full-width" multiple="multiple">
                                        <?php foreach ($subject_rows as $subject_row) : ?>
                                            <option value="<?= $subject_row['id'] ?>"> <?= $subject_row['name'] ?> </option>
                                        <?php endforeach ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <label for="author_id" class=" control-label">نویسنده</label>
                                <select class="form-control" id="author_id" name="author_id">
                                    <option value="0">انتخاب کنید</option>
                                    <?php foreach ($authors_rows as $authors_row) : ?>
                                        <option value="<?= $authors_row['id'] ?>"> <?= $authors_row['full_name'] ?> </option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="publish_year" class="control-label">سال انتشار</label>
...
<link href="<?php echo $HOST_NAME; ?>resources/plugins/select2/select2.min.css" rel="stylesheet" />
<script type="text/javascript" src="<?php echo $HOST_NAME; ?>resources/plugins/select2/select2.min.js?v.d.0.0.1"></script>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/resources.js"></script>