		...
		<div class="row">
			<div class="col col-lg-8 m-auto col-md-8 col-sm-12 col-12">
				<div class="main-header-content">
					...
					<h3 > <i class="fa fa-2x fa-robot right-menu-icon" ></i>
						مدیریت رباتها
			...
			<div class="ui-block">
				...
				<table class="forums-table">
					...
					<tr>
						...
						<td class="topics">
							<a id="new_robot_count_<?= $subject["id"]; ?>"   href="#" class="h6 count">0</a>
						</td>

						<td class="freshness">
                        <a href="<?php echo $HOST_NAME; ?>admin/crawler-sources/<?= $subject["id"]; ?>" class="btn btn-sm bg-blue">مدیریت<div class="ripple-container"></div></a>
						</td>
					</tr>
                    <?php endforeach; ?>
...
<script src="<?php echo $HOST_NAME; ?>app/admin/scripts/robot_management.js"></script>