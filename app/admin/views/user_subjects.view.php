                    ...
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            ...
                            <div class="block-btn align-right" >
                                <button  data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-md-2">افزودن +</button>
                                <!-- <button  name="btndelete" id="btndelete" class="btn btn-danger btn-md"  onclick="return checkElement();">حذف  -</button> -->
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" name="frmUserSubjects" id="frmUserSubjects" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control" id="subject" name="subject" onchange='set_subject_name();'>

                                    <option value="0" data-name="">انتخاب کنید</option>

                                    <?php foreach ($subject_rows as $result) :     ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control" id="role" name="role">
                                    <option value="2">مدیر موضوع</option>
...
<script src="<?php echo $HOST_NAME;  ?>app/admin/scripts/user_subjects.js"></script>