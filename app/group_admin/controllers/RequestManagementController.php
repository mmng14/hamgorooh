...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    //sample user of PDO directly if needed;
    // $stmt = $pdo->prepare("SELECT id, name, family FROM users");
    // $stmt->execute();
    ...
    $user_list_query = $database->select("SELECT * from users");
    ...
    $page_content = $ROOT_DIR . "app/group_admin/views/request_management.view.php";
