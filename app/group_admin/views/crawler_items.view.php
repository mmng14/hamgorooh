                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">مدیریت لینکهای منابع</div>
                            <input type="hidden" name="selected_subject_id" id="selected_subject_id" value="<?php echo $selected_subject_id; ?>" />
                            <input type="hidden" name="selected_source_id" id="selected_source_id" value="<?php echo $selected_source_id; ?>" />
            ...
            <div class="modal-dialog window-popup create-photo-album" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h6 class="title">افزودن / ویرایش لینک منابع</h6>
                    </div>
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formCrawlerItems" id="formCrawlerSources" role="form" method="post">
                            ...
                            <div class="form-group">
                                <label for="item_link" class="control-label">آدرس پست </label>
...
<script src="<?php echo $HOST_NAME; ?>app/group_admin/scripts/crawler_items.js"></script>