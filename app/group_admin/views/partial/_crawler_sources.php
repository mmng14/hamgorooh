<div class="table-responsive mailbox-messages">
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                <th>ردیف</th>
                <th class="hidden-480">نام سایت</th>
                <!-- <th class="hidden-phone">تصویر</th> -->
                <th class="hidden-phone">گروه</th>
                <th class="hidden-phone">فایل ربات</th>
                <th class="hidden-phone">آدرس منبع</th>
                <th class="hidden-phone">لینکها</th>
            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['category_id']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['crawler']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['source_link']; ?></b></td>
                        <td class="mailbox-subject"><a href="<?= $HOST_NAME?>group_admin/crawler-items/<?= $result['subject_id']; ?>/<?= $result['id']; ?>"><i class="fa fa-3x fa-paperclip"></i></a></td>
