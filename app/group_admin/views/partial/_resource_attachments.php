    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">نوع ضمیمه</th>
                <th class="hidden-phone">آدرس ضمیمه</th>
                ...
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject">
                            <img alt="" src="<?= $HOST_NAME . $result['photo_address'] ?>" width="70" />
                        </td>

                        <?php
                              $attachment_type = "نا مشخص";
                              if($result['attachment_type']==1){$attachment_type = "فایل PDF";}
                              if($result['attachment_type']==2){$attachment_type = "فایل WORD";} 
                              if($result['attachment_type']==3){$attachment_type = "فایل صوتی";} 
                              if($result['attachment_type']==4){$attachment_type = "فایل ویدیویی";} 
                              if($result['attachment_type']==5){$attachment_type = "لینک";}           
                        ?>
                        <td class="mailbox-subject"><b><?= $attachment_type ?></b></td>

                        <td class="mailbox-subject"><a href="<?= $result['link_address']; ?>" target="_blank"><i class="fa fa-3x fa-download"></i></a></td>
