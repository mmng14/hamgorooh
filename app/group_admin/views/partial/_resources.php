            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        <td class="mailbox-subject"><b><?= $result['categories']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['publish_year']; ?></b></td>
                        <td class="mailbox-subject"><a href="<?= $HOST_NAME?>group_admin/resources-attachments/<?= $result['id']; ?>"><i class="fa fa-3x fa-paperclip"></i></a></td>
