    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                ...
                <th class="hidden-phone">اهمیت</th>
            ...
            <?php if (isset($model)) : ?>
                <?php foreach ($model as $result) : ?>
                    <tr>
                        ...
                        $importance_text = "";
                        if ($result['importance'] == '1') $importance_text = "1 رتبه ";
                        if ($result['importance'] == '2') $importance_text = "2 رتبه";
                        if ($result['importance'] == '3') $importance_text = "3 رتبه";
                        if ($result['importance'] == '4') $importance_text = "4 رتبه";
                        if ($result['importance'] == '5') $importance_text = "5 رتبه";
                        ?>
                        <td><?= ++$counter ?></td>

                        <td class="mailbox-subject"><b><?= $result['title']; ?></b></td>
                        <td class="mailbox-subject">
                            <img alt="" src="<?= $HOST_NAME . $result['photo_address'] ?>" width="90px" height="50px" />
                        </td>
                        <td class="mailbox-subject"><b><?= $importance_text ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['ordering']; ?></b></td>
                        <td class="mailbox-subject"><b><?= $result['register_date']; ?></b></td>
                    ...
                    >
                        ...
                        <td class="mailbox-date">
                            ...
                            <button class="btn btn-primary btn-sm" data-toggle="modal" href="#add-resource" onclick="setData('<?= $result['id'] ?>')">
