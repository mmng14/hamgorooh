                        ...
                        <div class="ui-block responsive-flex">
                            <div class="ui-block-title">
                                ...
                                <div class="block-btn align-right">
                                    <a href="<?php echo $HOST_NAME; ?>group_admin/post_add/<?php echo $this_subject_id; ?>/" class="btn btn-green btn-md">افزودن
                                    </a>
                                ...
                                <div class="block-btn align-right">
                                    ...
                                    <select id="category_filter" name="category_filter" class="form-control selectpicker" aria-controls="sample_1">
                                        ...
                                        <?php if (isset($category_filter_rows) && $category_filter_rows != null) : ?>
                                            <?php foreach ($category_filter_rows as $category_filter_row) : ?>
                                                <option value="<?php echo $category_filter_row["id"]; ?>" <?php if ($category_filter_row["id"] == $category_filter) echo " selected "; ?>>
...
<script src="<?php echo $HOST_NAME; ?>app/group_admin/scripts/post.js"></script>