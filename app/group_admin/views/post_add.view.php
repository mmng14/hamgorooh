                                ...
                                <div class="row">
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <select id="category_id" name="category_id" class="form-control selectpicker" aria-controls="sample_1">
                                    ...
                                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <a href="<?php echo $HOST_NAME; ?>group_admin/posts/<?php echo $selected_subject_id ?>" name="cancel" id="cancel" class="btn btn-md btn-danger">
...
<script src="<?php echo $HOST_NAME; ?>app/group_admin/scripts/post_add.js"></script>
