    ...
    <div class="row">
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            ...
                            <input type="hidden" id="selected_resource_id" name="selected_resource_id" value="<?= $selected_resource["id"] ?>" />
                            <input type="hidden" id="selected_subject_id" name="selected_subject_id" value="<?= $selected_resource["subject_id"] ?>" />
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <!-- Tab panes -->
                    <h6 class="title"> <span style="color: #999;"> ضمایم مربوط به :  </span><b><?= $selected_resource["title"] ?></b></h6>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formResourceAttachments" id="formResourceAttachments" role="form" method="post">
                            ...
                            <input type="hidden" id="resource_id" name="resource_id" value="<?= $selected_resource["id"] ?>" />
...
<script src="<?php echo $HOST_NAME; ?>app/group_admin/scripts/resource_attachments.js"></script>