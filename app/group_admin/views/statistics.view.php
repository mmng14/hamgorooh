		...
		<div class="row">
			<div class="col col-lg-8 m-auto col-md-8 col-sm-12 col-12">
				<div class="main-header-content">
					<h3>آمار بازدید از گروه <?= $statictic_subject_name ?> </h3>					
					<p> وضعیت کلی گروه <?= $statictic_subject_name ?> از این قسمت قابل بررسی می باشد </p>
				</div>
			</div>
		</div>
	</div>
...
<div class="container">
	...
	<div class="row" id="statistics">
		...
		<form>
		<input type="hidden" id="statictic_subject_id" name="statictic_subject_id" value="<?= $statictic_subject_id ?>" />
...
<script src="<?php echo $HOST_NAME;  ?>app/group_admin/scripts/statistics.js"></script>