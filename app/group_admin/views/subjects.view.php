                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <div class="control-block-button" data-swiper-parallax="-100">
                                            ...
                                            <a href="<?php echo $HOST_NAME; ?>group_admin/statistics/<?php echo $subject["id"] ?>"  class="btn  bg-blue">
                                               آمار بازدید
                                               <svg class="olymp-stats-icon right-menu-icon">
...
<script src="<?php echo $HOST_NAME; ?>app/group_admin/scripts/subjects.js"></script>