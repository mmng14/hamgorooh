                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title"> نقش کاربران در گروه <span class="btn btn-success btn-round "> <?= $this_category_name ?>  </span></div>

                            <div class="block-btn align-right">
                                <!-- <button class="btn btn-primary btn-md-2" data-toggle="modal"  onclick="sendToAll('<?= $reportage_id ?>');">ارسال به همه گروهها
                                </button> -->
                    
                                <input type="hidden" name="thisCategoryId" id="thisCategoryId" value="<?= $this_category_id ?>" />
                                <input type="hidden" name="thisSubjectId" id="thisSubjectId" value="<?= $this_subject_id ?>" />
...
<script src="<?php echo $HOST_NAME;  ?>app/group_admin/scripts/user_management.js"></script>