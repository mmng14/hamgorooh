				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<div class="shop-product-item">
						<div class="product-thumb">
							<a href="<?= $resource_link ?>" title="<?= $resource['title'] ?>">
								<img src="<?= $HOST_NAME . $resource['photo_address']  ?>" alt="<?= $resource['title']  ?>">
							</a>
						</div>
						<div class="product-content">
							<div class="block-title">
								<a href="<?= $resource_link ?>" class="h5 title"><?= $resource['title']  ?></a>
								<a href="<?= $resource_link ?>" class="product-category"><?= $resource['brief_description']  ?></a>
							</div>
							<div class="block-price">
								...
								<div class="product-price"> شماره :  <?= $resource['ordering']  ?></div>

								<a href="<?= $resource_link ?>" class="in-cart" title="<?= $resource['title']  ?>">
