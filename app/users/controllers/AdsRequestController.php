...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $page_content = $ROOT_DIR . "app/users/views/ads_request.view.php";
...
if (
    ...
    $html = view_to_string("_ads_request.php", "app/users/views/partial/", $viewModel, $pagination, $SUBFOLDER_NAME, $HOST_NAME);
    echo $html;
    exit;
}
...
//////////// Functions ///////////
function addDaysToPersianDate($last_ads_end_date, $active_days)
{
    //Convert to gregorian
    $arrayJalaliToGregorian = explode('/', $last_ads_end_date);
    $year = $arrayJalaliToGregorian[0];
