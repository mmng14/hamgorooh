...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($url_subject_id)) {
        ...
        $selected_subject_id = $url_subject_id; // TODO hash id later
        ...
        $subject = $database->subject[$selected_subject_id];
    ...
    $page_content = $ROOT_DIR . "app/users/views/group_messages.view.php";
