                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            <div class="h6 title">درخواست تبلیغات</div>

                            <div class="block-btn align-right">
                                <!-- <h4>در خواست تبلیغات</h4> -->

                                <a class="btn btn-green" data-toggle="modal" href="#myModal" onclick="clearData();">در خواست تبلیغات
                                </a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" name="formAds" id="formAds" role="form" method="post">
                            ...
                            <button type="submit" id="save" name="save" class="btn btn-green btn-sm btn-send">ذخیره</button>
                            <button class="btn btn-grey btn-sm" data-dismiss="modal">بستن</button>     
...
<script src="<?php echo $HOST_NAME; ?>app/users/scripts/ads_request.js"></script>