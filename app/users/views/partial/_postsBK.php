                ...
                <?php foreach ($model as $result) :  ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $HOST_NAME; ?>users/post_add/<?php echo $link_category_id; ?>/<?php echo $link_post_id; ?>" class="btn btn-primary btn-sm btn-link-custom" onclick="setData('<?= $result['id'] ?>')">
