                    ...
                    <div class="ui-block responsive-flex">
                        <div class="ui-block-title">
                            ...
                            <div class="block-btn align-right">
                                <!-- <h4>در خواست رپرتاژ</h4> -->

                                <a class="btn btn-green" data-toggle="modal" href="#myModal" onclick="clearData();">در خواست رپرتاژ
                                </a>
...
<script src="<?php echo $HOST_NAME; ?>app/users/scripts/reportage_request.js"></script>