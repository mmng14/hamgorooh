(CRUMINA.Bootstrap = function () {
  ...
  if (e.length) {
    ...
    e.daterangepicker({
      ...
      e.on("apply.daterangepicker", function (e, i) {
        $(this).val(i.startDate.format("DD/MM/YYYY")),
          $(this).closest(".form-group").addClass("is-focused");
      }),
  ...
  (CRUMINA.FormValidation = function () {
    $(".needs-validation").each(function () {
      ...
      e.addEventListener(
        "submit",
        function (i) {
          0 == e.checkValidity() && (i.preventDefault(), i.stopPropagation()),
  ...
  $(document).ready(function () {
    ...
    //           (e.name
    //             ? '<span class="h6 notification-friend"></a>' +
    //               i(e.name) +
    //               "</span>"
    //             : "") +
    //           (e.message
...
$(document).ready(function () {
  ...
  $(".swiper-container").each(function () {
    ...
    a.addClass("swiper-" + t + " initialized").attr("id", t),
      a.find(".swiper-pagination").addClass("pagination-" + t);
      ...
      for (var e in this.maps) {
        ...
        if (i.config && i.markers && document.getElementById(i.config.id)) {
          ...
          i.markers.forEach(function (e) {
            ...
            a.addLayer(t),
            this.disableScroll(jQuery("#" + i.config.id), a);
        }
      }
    },
