...
Connect();
$rows=select('crawler_source','*',"status='1' AND subject_id=17","limit 1");
...
else
{
    ...
    $msg = update("crawler_source", "status=1", "subject_id=17  AND status=0"); 
}
