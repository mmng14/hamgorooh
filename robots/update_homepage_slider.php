...
$slider_list = select('slider', '*', "status=1", " ORDER BY ordering DESC LIMIT 6");


$slider = "";
foreach ($slider_list as $slider_item) {

    $slider_link_address = $slider_item["link"];
    $slider_photo_address = $HOST_NAME . $slider_item["photo"];
    $slider_title = $slider_item["title"];
    $slider_description = $slider_item["description"];
